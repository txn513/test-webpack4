    ...
    <div>
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form align="right" :inline="true"  class="demo-form-inline">
                ...
                <el-form-item >
                    <el-button type="primary" v-on:click="getBusyMember">查询</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        <div class="toolbar el-col el-col-24" v-loading="listLoading" style="margin:0;padding:0;background: none;">
        ...
        <el-row style="position:static;" v-loading="listLoading">
            ...
            <h1 style="font-size: 18px; ">活跃明细</h1>
            <el-col :span="12">
...
<script>
    import {getBusyMemberFun} from '../../api/api';
    ...
    export default {
        ...
        methods:{
            ...
            getBusyMember() {
                ...
                this.listLoading = true;
                getBusyMemberFun(para).then((data) => {
                    this.listLoading = false;
                    this.data1=[];
                    this.data2=[];
                    this.tableData1=[];
                    ...
                    if (this.GLOBAL.isResonseSuccess(data)){
                        ...
                        if(countByCity.length>=1){
                            ...
                            //处理数据库为空或者为null的城市
                            var newArr = [];
                            for(var i=0;i<countByCity.length;i++){
                                if(countByCity[i].cityName=='' || countByCity[i].cityName==null){
                                    countByCity[i].cityName='未定义';
                                }
                                if(countByCity[i].number1!=0){
                                    newArr.push(countByCity[i]);
                                }
                            }
                        }
