<template>
    <section>
        ...
        <div  class="toolbar" style="padding-bottom: 0px;justify-content: space-between;">
            <span>自营订单->退货详情-><span class="order-status">已完成</span></span>
        ...
        <h3 style="margin-top: 50px;">物流信息</h3>

        <h3 style="margin-top: 50px;">收货信息</h3>
        <el-table :data="confirmData" style="width: 100%" stripe border  aria-label="订单信息">
            <el-table-column prop="operator" label="收货人" show-overflow-tooltip></el-table-column>
            <el-table-column prop="operationContent" label="处理信息" show-overflow-tooltip></el-table-column>
            <el-table-column prop="updateTime" label="收货时间" show-overflow-tooltip sortable :formatter="dateFormat"></el-table-column>
            <el-table-column prop="remark" label="处理备注" show-overflow-tooltip></el-table-column>
        </el-table>

        <h3 style="margin-top: 50px;">财务信息</h3>

    </section>
</template>
<script>
    import util from '../../../common/js/util'
    import {searchOrderReturnComplete} from '../../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            searchOrderReturn(){
                ...
                searchOrderReturnComplete(para).then((res) => {
                    ...
                    if (this.GLOBAL.isResonseSuccess(res)){
                        ...
                        this.confirmData = [list.orderConfirmInformation];//收货信息
