...
<script>
    import {getShopList, removeShopInfo,getAvailableStores,getAllStores,getAvailableServices,getAllServices, queryArea, editShopInfo, addShopInfo,updateShopStatus,getOrgListByTypeAndBusinessType} from '../../api/api';
