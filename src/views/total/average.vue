	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form align="right" :inline="true"  class="demo-form-inline">
				...
				<!--按钮-->
				<el-button type="primary"  v-on:click="getAveragePrice(true)" :loading="listLoading" icon="el-icon-search">查询</el-button> &nbsp; &nbsp;
			</el-form>
		</el-col>
		<!--table-->
		<el-table
...
<script>
    ...
    import { getAveragePricePage} from '../../api/api';
	...
	export default {
        ...
        methods: {
            ...
            getAveragePrice(flag) {
                ...
                getAveragePricePage(para).then((data) => {
